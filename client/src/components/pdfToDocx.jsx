...
function PdfToDoc(props) {
    ...
    function handleConvert() {
        ...
        axios({
            method: "post",
            url: "http://localhost:8080/api/pdf-converter/toDocx",
            data: bodyFormData,
    ...
    const handleDownload = () => {
        downloadBase64File("application/vnd.openxmlformats-officedocument.wordprocessingml.document", res, file[0].name.replace(/\.[^/.]+$/, ""));
    }
